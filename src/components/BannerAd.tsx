...
export const BannerAd: React.FC<BannerAdProps> = ({ className = '' }) => {
  ...
  return (
    <div
      ...
      className={`bg-slate-100/90 dark:bg-slate-850/90 border-t border-slate-200/80 dark:border-slate-800/80 px-3 py-2 relative overflow-hidden transition-all select-none ${className}`}
    >

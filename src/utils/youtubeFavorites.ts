...
export const DEFAULT_YOUTUBE_FAVORITES: YouTubeSavedUrl[] = [
  ...
  },
  {
    id: 'fav-9Auq9mYxFEE',
    videoId: '9Auq9mYxFEE',
    url: 'https://www.youtube.com/live/9Auq9mYxFEE',
    title: 'Sky News Live | 英國與全球即時新聞 (24/7 即時新聞直播)',
    channelName: 'Sky News',
    savedAt: 1710750000000,
    isLive: true,
  },
  {
    id: 'fav-dp8PhLsUcFE',
    videoId: 'dp8PhLsUcFE',
    url: 'https://www.youtube.com/live/dp8PhLsUcFE',
    title: 'Bloomberg Television Live | 全球市場與商業財經 (24/7 即時直播)',
    channelName: 'Bloomberg Television',
    savedAt: 1710720000000,
    isLive: true,
  },
  {
    id: 'fav-MiAl9CNZUuo',
